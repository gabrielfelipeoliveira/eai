...
- `EAI-008`: em andamento. Ajustar notas, observacoes, tags globais e historico de lead.
...
- `EAI-008`: ajustar notas, observacoes, tags globais e historico de lead.

Branch sugerida:

```text
feature/eai-008-notas-tags-historico-lead
```
