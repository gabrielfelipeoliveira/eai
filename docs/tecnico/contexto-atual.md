...
- `EAI-065`: concluido no PR `#127`. Revalidado em 2026-09-03: excecoes Trivy do `gosu` ainda necessarias em `postgres:16-bookworm` no digest `sha256:bb3e1a57e5407e0a5280b4211980a5e537f4abd234a87014ac979849a78dd825`; revisar novamente ate `2026-10-31`.
