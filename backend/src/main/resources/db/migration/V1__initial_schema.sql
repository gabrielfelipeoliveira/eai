...
CREATE TABLE user_roles (
    ...
    role VARCHAR(30) NOT NULL CHECK (role IN ('ADMIN', 'MANAGER', 'SELLER', 'RECEPTIONIST', 'AUDITOR')),
...
VALUES
    ...
    ('00000000-0000-0000-0000-000000000021', 'Recepcao EAI', 'recepcao@eai.com', '$2a$10$rittMsrhSOzttZy/ST1Pz.AEC1YrNnxA7MaGVS2JApfL871P.yn/6', '11990000021', 'Recepcao', 'ACTIVE', '00000000-0000-0000-0000-000000000101', '00000000-0000-0000-0000-000000000201', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
VALUES
    ...
    ('00000000-0000-0000-0000-000000000021', 'RECEPTIONIST'),
...
VALUES
    ...
    ('00000000-0000-0000-0000-000000000802', '00000000-0000-0000-0000-000000000502', '00000000-0000-0000-0000-000000000021', NULL, 'AVAILABLE', 'Lead cadastrado pela recepcao.', CURRENT_TIMESTAMP - INTERVAL '3' HOUR),
